...
public class VFX3DUtil {
     ...
     * @param eventReceiver receiver of the event
     * @param btn mouse button that shall be used for this behavior
     * @param firstAxis first rotation axis
     * @param secondAxis second rotation axis
     */
    public static void addMouseBehavior(
            Node n, Node eventReceiver, MouseButton btn, Point3D firstAxis, Point3D secondAxis) {
        eventReceiver.addEventHandler(MouseEvent.ANY,
...
class MouseBehaviorImpl1 implements EventHandler<MouseEvent> {
    ...
    public MouseBehaviorImpl1(Node n, MouseButton btn) {
        this(n, btn, Rotate.X_AXIS, Rotate.Z_AXIS);
    }

    public MouseBehaviorImpl1(Node n, MouseButton btn, Point3D firstAxis, Point3D secondAxis) {
    ...
    public void handle(MouseEvent t) {
        ...
        // TODO Sebstian nach einer schöneren Implementierung fragen!
